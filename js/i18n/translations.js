...
IQRAA.i18n.translations = {
    ...
    adminOverview: {
      ...
      retry: "ניסיון חוזר",
      heroGreetingMorning: "בוקר טוב",
      heroGreetingAfternoon: "צהריים טובים",
      heroGreetingEvening: "ערב טוב",
      heroSubtitleLeadsPart: "לידים חדשים ממתינים לטיפול",
      heroSubtitleOverduePart: "משימות באיחור דורשות תשומת לב",
      heroSubtitleAllGood: "כל הפרויקטים הפעילים מתקדמים כשורה, ואין משימות באיחור.",
      heroCtaLeads: "לצפייה בלידים החדשים",
      heroCtaProjects: "למעבר לפרויקטים",
    },
    projects: {
      ...
      tabAll: "הכל",
      tabNoStage: "ללא שלב",
      kpiTotalLabel: 'סה"כ פרויקטים',
      kpiInProgressLabel: "בתהליך",
      kpiReadyToStartLabel: "מוכנים להתחלה",
      kpiCompletedLabel: "הושלמו",
    },
    projectWorkspace: {
    ...
    leads: {
      ...
      tabAll: "הכל",
      kpiTotalLabel: 'סה"כ לידים',
      kpiWaitingPaymentLabel: "ממתינים לתשלום ראשון",
      kpiFirstPaymentPaidLabel: "תשלום ראשון התקבל",
      kpiProcessedLabel: "הושלמו",
    },
    clientFields: {
      contact: "איש קשר",
      organization: "ארגון",
    ...
    clients: {
      ...
      retry: "ניסיון חוזר",
      tabAll: "כל הלקוחות",
      tabWithActiveProjects: "עם פרויקטים פעילים",
      tabWithoutActiveProjects: "ללא פרויקטים פעילים",
      kpiTotalLabel: 'סה"כ לקוחות',
      kpiActiveProjectsLabel: 'סה"כ פרויקטים פעילים',
      kpiWithActiveLabel: "לקוחות עם פרויקט פעיל",
      kpiWithoutActiveLabel: "לקוחות ללא פרויקט פעיל",
    },
    pmOverview: {
    ...
    team: {
      ...
      tabAll: "הכל",
      kpiTotalLabel: 'סה"כ חברי צוות',
      kpiActiveLabel: "פעילים",
      kpiInactiveLabel: "לא פעילים",
    },
    clientOverview: {
